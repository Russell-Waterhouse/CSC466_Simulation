...
def run():
    ...
    info(net['r999'].cmd("ip route add 10.0.0.0/24 via 10.100.0.1 dev r2-eth2")) # r999 -> r1
    info(net['r999'].cmd("ip route add 10.1.0.0/24 via 10.100.0.2 dev r2-eth2")) # r999 -> r2
